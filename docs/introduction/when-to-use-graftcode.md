...
![Five Graftcode integration scenarios: frontend to backend, backend to backend, backend to AI, polyglot in-memory runtime, and public API integration](../../assets/diagrams/5-graftcode-scenarious.png)
