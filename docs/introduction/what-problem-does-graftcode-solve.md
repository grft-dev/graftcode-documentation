...
method and its Caller. It does not make a distributed call local; it makes the Caller-facing
...
2. **The Graft is generated code.** It is a package for the Caller's package manager and language.
   It mirrors the Receiver surface; it is not the Receiver implementation. See
