...
[Package installation fails](package-installation.md). If Vision still differs from startup output,
continue with [Vision and runtime disagree](vision-mismatch.md).
