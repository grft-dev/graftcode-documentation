...
[Gateway or runtime exits](gateway-or-runtime-exits.md). If calls reach an old method after reconnection, continue
with [Installed package is stale](installed-package-is-stale.md).
